			...
			<div class="main">
				...
				<div class="result-wrap">
					<form name="myform" id="myform" method="post"
						action="news_addNewsUser.action">
						<div class="result-content">
							<table class="result-tab" width="100%">
								...
								<tr>
									<th>内容：</th>
									<th>
										<textarea rows="8" cols="120" name="content"></textarea>
										<s:fielderror cssStyle="color: black">
								...
								<%-- <tr>
									<th>来源：</th>
									<th><input type="text" name="comefrom"
										value="${sessionScope.user.uid }" style="width: 200px"></th>
								</tr> --%>
								<tr>
								...
								<tr>
									...
									<!-- value="{$requestScope.datetime}"></td> -->
									<td><input type="hidden" name="user.uid"
										value="${sessionScope.user.uid }" style="width: 200px"></td>
								</tr>
							</table>
						</div>
					</form>
